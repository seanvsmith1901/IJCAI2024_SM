...
even_two_plus_one = {
        ...
        11: [4, 4], 12: [5, 5], 13: [5,5], 14: [6, 6], 15: [6, 6], 16: [6, 6]
    }

small_minority_two_plus_one = {
    5: [2, 2], 6: [3, 2], 7: [3, 3], 8: [3, 3], 9: [4, 4], 10: [4, 4],
    11: [5, 4], 12: [5, 5], 13: [5, 5], 14: [6, 6], 15: [6, 6], 16: [7, 6]
}

large_minority_two_plus_one = {
    5: [2, 2], 6: [3, 2], 7: [3, 3], 8: [3, 3], 9: [4, 3], 10: [4, 4],
    11: [4, 4], 12: [5, 5], 13: [5, 5], 14: [6, 5], 15: [6, 6], 16: [6, 6]
}
