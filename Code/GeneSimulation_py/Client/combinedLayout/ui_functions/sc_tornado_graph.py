...
def create_sc_tornado_graph(main_window):
    ...
    main_window.tornado_ax.tick_params(color="#EBEBEB")
    main_window.tornado_ax.xaxis.set_tick_params(labelcolor="white")  # Set x-axis tick labels to white
    main_window.tornado_ax.yaxis.set_tick_params(labelcolor="white")  # (Optional) Set y-axis tick labels to white
